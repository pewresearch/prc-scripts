...
(Object.getOwnPropertyDescriptor(createReboundMethod, "name") || {}).writable || Object.defineProperty(createReboundMethod, "name", { value: "default", configurable: true });
...
(Object.getOwnPropertyDescriptor(rebindAll, "name") || {}).writable || Object.defineProperty(rebindAll, "name", { value: "default", configurable: true });
...
(Object.getOwnPropertyDescriptor(regexify, "name") || {}).writable || Object.defineProperty(regexify, "name", { value: "default", configurable: true });
...
(Object.getOwnPropertyDescriptor(include, "name") || {}).writable || Object.defineProperty(include, "name", { value: "default", configurable: true });

;// ../../../../../../node_modules/@d3fc/d3fc-discontinuous-scale/src/discontinuity/identity.js
Object.defineProperty(discontinuity_identity, "name", { value: "default", configurable: true });
...
/* unused harmony import specifier */ var tradingDay;
/* unused harmony import specifier */ var dayBoundary;
/* unused harmony import specifier */ var millisPerDay;
 ...
 */
const base = (nonTradingPattern, dateTimeUtility) => {
...
/* harmony default export */ const skipWeeklyPattern = ((nonTradingHoursPattern) => base(nonTradingHoursPattern, localDateTimeUtility));
(Object.getOwnPropertyDescriptor(skipWeeklyPattern, "name") || {}).writable || Object.defineProperty(skipWeeklyPattern, "name", { value: "default", configurable: true });
;// ../../../../../../node_modules/@d3fc/d3fc-discontinuous-scale/src/discontinuity/skipUtcWeeklyPattern.js
/* unused harmony import specifier */ var skipUtcWeeklyPattern_base;
...
/* harmony default export */ const skipUtcWeeklyPattern = ((nonTradingUtcHoursPattern) => skipUtcWeeklyPattern_base(nonTradingUtcHoursPattern, utcDateTimeUtility));
(Object.getOwnPropertyDescriptor(skipUtcWeeklyPattern, "name") || {}).writable || Object.defineProperty(skipUtcWeeklyPattern, "name", { value: "default", configurable: true });
...
function groups(values, ...keys) {
  return nest(values, Array.from, group_identity, keys);
}
...
class PathString {
  constructor(digits) {
    this._append = digits == null ? string_append : appendRound(digits);
    this._radius = 4.5;
    this._ = "";
  }
  pointRadius(_) {
...
Object.defineProperty(path, "name", { value: "default", configurable: true });
...
Object.defineProperty(buffer, "name", { value: "default", configurable: true });
...
/* unused harmony import specifier */ var circle_constant;
/* unused harmony import specifier */ var circle_degrees;
/* unused harmony import specifier */ var circle_radians;
/* unused harmony import specifier */ var rotateRadians;
...
/* harmony default export */ function circle() {
  var center = circle_constant([0, 0]),
      radius = circle_constant(90),
      precision = circle_constant(2),
      ring,
      rotate,
      stream = {point: point};
  ...
  function point(x, y) {
    ...
    x[0] *= circle_degrees, x[1] *= circle_degrees;
  }

  function circle() {
    var c = center.apply(this, arguments),
        r = radius.apply(this, arguments) * circle_radians,
        p = precision.apply(this, arguments) * circle_radians;
    ring = [];
    rotate = rotateRadians(-c[0] * circle_radians, -c[1] * circle_radians, 0).invert;
  ...
  circle.center = function(_) {
    return arguments.length ? (center = typeof _ === "function" ? _ : circle_constant([+_[0], +_[1]]), circle) : center;
  };

  circle.radius = function(_) {
    return arguments.length ? (radius = typeof _ === "function" ? _ : circle_constant(+_), circle) : radius;
  };

  circle.precision = function(_) {
    return arguments.length ? (precision = typeof _ === "function" ? _ : circle_constant(+_), circle) : precision;
  };
...
/* unused harmony import specifier */ var rotation_radians;
/* unused harmony import specifier */ var rotation_degrees;
...
/* harmony default export */ function rotation(rotate) {
  rotate = rotation_rotateRadians(rotate[0] * rotation_radians, rotate[1] * rotation_radians, rotate.length > 2 ? rotate[2] * rotation_radians : 0);

  function forward(coordinates) {
    coordinates = rotate(coordinates[0] * rotation_radians, coordinates[1] * rotation_radians);
    return coordinates[0] *= rotation_degrees, coordinates[1] *= rotation_degrees, coordinates;
  }

  forward.invert = function(coordinates) {
    coordinates = rotate.invert(coordinates[0] * rotation_radians, coordinates[1] * rotation_radians);
    return coordinates[0] *= rotation_degrees, coordinates[1] *= rotation_degrees, coordinates;
  };
...
function projectionMutator(projectAt) {
  ...
  projection.clipAngle = function(_) {
    return arguments.length ? (preclip = +_ ? clip_circle(theta = _ * radians) : (theta = null, antimeridian), reset()) : theta * math_degrees;
  };
...
function conicEqualAreaRaw(y0, y1) {
  ...
  project.invert = function(x, y) {
    var r0y = r0 - y,
        l = atan2(x, math_abs(r0y)) * sign(r0y);
    if (r0y * n < 0)
...
Object.defineProperty(arc, "name", { value: "default", configurable: true });
...
Object.defineProperty(stack, "name", { value: "default", configurable: true });
